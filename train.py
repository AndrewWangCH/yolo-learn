...
def fit_ont_epoch(net, yolo_losses, train_loader):
    net.train()
    total_loss = 0
...
if __name__ == "__main__":
    ...
    lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=4, gamma=0.92)

    for epoch in range(500):
        total_loss = fit_ont_epoch(net, yolo_loss, train_loader)
        lr_scheduler.step()
